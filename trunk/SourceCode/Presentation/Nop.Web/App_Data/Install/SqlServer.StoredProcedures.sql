...
CREATE PROCEDURE [dbo].[SetMaximumCartQuantity]
...
BEGIN
	...
	UPDATE Product SET OrderMaximumQuantity = @Quantity
END
GO


CREATE PROCEDURE [dbo].[CustomProductLoadAllPaged]
(
...
BEGIN
	...
	--auto hidden product if quantity out of stock -------------------------------------------------------------------------------------------------
	IF @ShowHidden = 0
	BEGIN
		SET @sql = @sql + '
