...
namespace Nop.Web.Controllers
{
    public partial class ProductController : BasePublicController
    {
            ...
            ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
        {
            ...
            //allowed quantities
            var limitedQuantity = product.OrderMaximumQuantity;
            var allowedQuantities = product.ParseAllowedQuantities();
            foreach (var qty in allowedQuantities.Where(x=>x<=limitedQuantity))
            {
        ...
        [ChildActionOnly]
        public ActionResult RecentlyViewedProductsBlock(int? productThumbPictureSize, bool? preparePriceModel, string displayMode = "vertical")
        {
            if (!_catalogSettings.RecentlyViewedProductsEnabled)
                return Content("");
            ...
            return PartialView("RecentlyViewedProductsBlockDisplayHorizontal", model);
        }
